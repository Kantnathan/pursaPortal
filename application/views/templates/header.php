        ...
        <div class="sidebar">
            <nav class="sidebar-nav">
				...
				<?php if ($this->session->userdata('user_type') == 'superadmin' || $this->session->userdata('user_type') == 'admin'): ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url(); ?>investments/editPackages/1"><i class="icon-pie-chart"></i> Edit Packages For Clients</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url(); ?>investments/editPackages/2"><i class="icon-pie-chart"></i> Edit Packages For Staffs</a>
                    </li>
					<?php endif ?>
